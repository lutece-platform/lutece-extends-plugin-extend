 ...
 * 
 * @param <T>
 *            the type of elements in this ExtenderType (example: Hit)
 * @param IExtendableResourceResult
 *            the IExtendableResourceResult
 */
public class ExtenderType<T extends IExtendableResourceResult>
{
     ...
     * 
     * @param <T>
     *            the type of the output arguments of the getInfoExtender
     */
     ...
     * 
     * @param <T>
     *            the type of the output arguments of the getInfoExtenderByList
     */
     ...
     * 
     * @param Class<T>
     *            the Class type of the output arguments of the getInfoExtende and getInfoExtenderByList
     * @param strType
     *            the type of extender
     ...
     */
    public ExtenderType( Class<T> t, String strType, BiFunction<String, String, List<T>> getInfoExtender,
            BiFunction<List<String>, String, List<T>> getInfoExtenderByList, BinaryOperator<String> getInfoForExport, BinaryOperator<String> getInfoForRecap )
    {
        Objects.requireNonNull( t );
        Objects.requireNonNull( strType );
