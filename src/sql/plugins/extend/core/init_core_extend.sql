...
VALUES ('RESOURCE_EXTENDER_MANAGEMENT_BY_RESOURCE_TYPE','extend.adminFeature.resource_extenders_management_by_resource_type.name',2,'jsp/admin/plugins/extend/ManageResourceExtendersByResourceType.jsp','extend.adminFeature.resource_extenders_management_by_resource_type.description',0,'extend','CONTENT','images/admin/skin/plugins/extend/extend.png', 'jsp/admin/documentation/AdminDocumentation.jsp?doc=admin-extend');
INSERT INTO core_admin_right (id_right,name,level_right,admin_url,description,is_updatable,plugin_name,id_feature_group,icon_url, documentation_url) 
VALUES ('RESOURCE_EXTENDER_MANAGEMENT_BY_RESOURCE','extend.adminFeature.resource_extenders_management_by_resource.name',2,'jsp/admin/plugins/extend/ManageResourceExtendersByResource.jsp','extend.adminFeature.resource_extenders_management_by_resource.description',0,'extend','CONTENT','images/admin/skin/plugins/extend/extend.png', 'jsp/admin/documentation/AdminDocumentation.jsp?doc=admin-extend');
